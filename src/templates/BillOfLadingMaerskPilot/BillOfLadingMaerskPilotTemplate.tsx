...
const Section3 = (document: BillOfLadingMaerskPilotDocument): JSX.Element => {
  const {
    carrierName,
    carrierReceipt,
    placeOfIssueBL,
...
const Section2 = (document: BillOfLadingMaerskPilotDocument): JSX.Element => {
...
const Section1 = (document: BillOfLadingMaerskPilotDocument): JSX.Element => {
  const { logo, shipper = {}, scac, blNumber, consignee = {}, notifyParty = {} } = document;
  return (
    <div className="border-black border">
      <div className="flex">
        <div className="w-1/2 border-black border">
...
export const BillOfLadingMaerskPilotTemplate: FunctionComponent<TemplateProps<BillOfLadingMaerskPilotSchema>> = ({
  document,
}) => {
