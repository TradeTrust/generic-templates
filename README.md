...
| Bill of Exchange (Deprecated)   | EMBEDDED_RENDERER | BILL_OF_EXCHANGE                    | &cross;    | &check;      | -             | -              |
| Bill of Exchange                | EMBEDDED_RENDERER | BILL_OF_EXCHANGE_DOCUMENTARY_CREDIT | &cross;    | &check;      | -             | -              |
